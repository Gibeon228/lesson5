...
public class Main {
    ...
    /**
     * 1.  Создайте 2 текстовых файла, примерно по 50-100 символов в каждом(особого значения не имеет);
     * 2.  Написать метод, "склеивающий" эти файлы, т.е. вначале идет текст из первого фалйа, потом текст из второго.
...
//        }
        ...
        backUp.backUpFiles(Path.of("."));
    }

    private static void backup(String fileName, int length) throws IOException {
    ...
    /**
     * Записать последовательность символов в файл, случайным образом дописать осознанное слово для поиска
     *
     * @param fileName имя файла
     * @param length   длина последовательности символов
        ...
        try(FileInputStream fileInputStream = new FileInputStream(fileName)) {
            ...
            while ((c = fileInputStream.read()) != -1) {
                if (c == searchData[i]) {
                    ...
                    i = 0;
                    if (c == searchData[i]) i++; // GeekBrainGeekBrains
                    continue;
                }
